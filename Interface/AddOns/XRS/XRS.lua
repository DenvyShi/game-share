...
function XRS:OnInitialize()
	...
	waterfall:Register('XRSOPT', 'aceOptions', self.options, 'title','团队增益状态检查') 
	SLASH_XRSCMD1 = "/xrsoption";
	SlashCmdList["XRSCMD"] = function(msg)
		waterfall:Open('XRSOPT')
	end
...
function XRS:OutputBuffCheck(tbl)
    ...
    if (count>0) then self:RaidOutput("XRS团队增益检查: "..count..L[" missing buffs."]) end
