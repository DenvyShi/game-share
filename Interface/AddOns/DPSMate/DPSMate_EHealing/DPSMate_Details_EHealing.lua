...
function DPSMate.Modules.DetailsEHealing:UpdateDetails(obj, key)
	...
	db2 = DPSMate:GetModeByArr(DPSMate.Cache.DPSMateEHealingTaken, key, "EHealingTaken")
	...
	DetailsArr, DetailsTotal, DmgArr = DPSMate.Modules.EffectiveHealing:EvalTable(DPSMate.Cache.DPSMateUser[DetailsUser], curKey)
	...
	if not g then
		...
		g2=DPSMate.Options.graph:CreateGraphLine("EHLineGraph",DPSMate_Details_EHealing_DiagramLine,"CENTER","CENTER",0,0,950,230)
		g3=DPSMate.Options.graph:CreateStackedGraph("EHStackedGraph",DPSMate_Details_EHealing_DiagramLine,"CENTER","CENTER",0,0,950,230)
	...
	DPSMate_Details_EHealing:SetScale((DPSMate.DPSMateSettings["targetscale"] or 0.58)/UIParent:GetScale())
end
...
function DPSMate.Modules.DetailsEHealing:UpdateCompare(obj, key, comp)
	...
	DPSMate_Details_CompareEHealing_SubTitle:SetText(DPSMate.L["activity"]..strformat("%.2f", DPSMate.Cache.DPSMateCombatTime["effective"][key][comp] or 0).."s "..DPSMate.L["of"].." "..strformat("%.2f", cbt).."s ("..strformat("%.2f", 100*(DPSMate.Cache.DPSMateCombatTime["effective"][key][comp] or 0)/cbt).."%)")
	...
	if not g4 then
		...
		g5=DPSMate.Options.graph:CreateGraphLine("EHLineGraphComp",DPSMate_Details_CompareEHealing_DiagramLine,"CENTER","CENTER",0,0,950,230)
		g6=DPSMate.Options.graph:CreateStackedGraph("EHStackedGraphComp",DPSMate_Details_CompareEHealing_DiagramLine,"CENTER","CENTER",0,0,950,230)
		...
		g6:SetXLabels(true)
		g7=DPSMate.Options.graph:CreateGraphLine("EHLineGraphSum",DPSMate_Details_CompareEHealing_Graph,"CENTER","CENTER",0,0,1950,230)
	end
...
function DPSMate.Modules.DetailsEHealing:ScrollFrame_Update(comp)
	...
	for line=1,10 do
		...
		if uArr[lineplusoffset] ~= nil then
			...
			if len < 10 then
				_G("DPSMate_Details_"..comp.."EHealing_Log_ScrollButton"..line):SetWidth(335)
				_G("DPSMate_Details_"..comp.."EHealing_Log_ScrollButton"..line.."_Name"):SetWidth(225)
			else
				_G("DPSMate_Details_"..comp.."EHealing_Log_ScrollButton"..line):SetWidth(320)
				_G("DPSMate_Details_"..comp.."EHealing_Log_ScrollButton"..line.."_Name"):SetWidth(210)
			end
...
function DPSMate.Modules.DetailsEHealing:CreateGraphTable(comp)
	...
	for i=1, 8 do
		-- Horizontal
		lines[i] = DPSMate.Options.graph:DrawLine(_G("DPSMate_Details_"..comp.."EHealing_LogDetails_EHealing"), 5, 270-i*30, 376, 270-i*30, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
		lines[i]:Show()
	end
	-- Vertical
	lines[9] = DPSMate.Options.graph:DrawLine(_G("DPSMate_Details_"..comp.."EHealing_LogDetails_EHealing"), 57, 265, 57, 2, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
	lines[9]:Show()
	
	lines[10] = DPSMate.Options.graph:DrawLine(_G("DPSMate_Details_"..comp.."EHealing_LogDetails_EHealing"), 192, 265, 192, 2, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
	lines[10]:Show()
	
	lines[11] = DPSMate.Options.graph:DrawLine(_G("DPSMate_Details_"..comp.."EHealing_LogDetails_EHealing"), 252, 265, 252, 2, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
	lines[11]:Show()
	
	lines[12] = DPSMate.Options.graph:DrawLine(_G("DPSMate_Details_"..comp.."EHealing_LogDetails_EHealing"), 312, 265, 312, 2, 20, {0.5,0.5,0.5,0.5}, "BACKGROUND")
	lines[12]:Show()
end
