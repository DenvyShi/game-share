...
function ShaguPlates:LoadConfig()
  ...
  ShaguPlates:UpdateConfig("thirdparty", "dpsmate",     "skin",             "1")
  ShaguPlates:UpdateConfig("thirdparty", "dpsmate",     "dock",             "1")
  ShaguPlates:UpdateConfig("thirdparty", "shagudps",    "skin",             "1")
  ShaguPlates:UpdateConfig("thirdparty", "shagudps",    "dock",             "1")
  ShaguPlates:UpdateConfig("thirdparty", "swstats",     "skin",             "1")
  ShaguPlates:UpdateConfig("thirdparty", "swstats",     "dock",             "1")
  ShaguPlates:UpdateConfig("thirdparty", "ktm",         "skin",             "1")
  ShaguPlates:UpdateConfig("thirdparty", "ktm",         "dock",             "1")
  ...
  ShaguPlates:UpdateConfig("thirdparty", "recount",     "skin",             "1")
  ShaguPlates:UpdateConfig("thirdparty", "recount",     "dock",             "1")
  ShaguPlates:UpdateConfig("thirdparty", "omen",        "skin",             "1")
  ShaguPlates:UpdateConfig("thirdparty", "omen",        "dock",             "1")
