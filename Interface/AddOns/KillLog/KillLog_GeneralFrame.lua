...
function KillLog_GeneralFrame_OnShow()
  ...
  DebugMessage("KL", "死亡: " .. tableDeath, "helper");
  DebugMessage("KL", "总计死亡: " .. totalDeath, "helper");

  table.insert(creepList, { name = "击杀总数", value = totalKill });
  table.insert(creepList, { name = "    一般击杀", value = normalKill });
  table.insert(creepList, { name = "    稀有击杀", value = rareKill });
  table.insert(creepList, { name = "    精英击杀", value = eliteKill });
  table.insert(creepList, { name = "    稀有精英击杀", value = rareEliteKill });
  table.insert(creepList, { name = "    boss击杀", value = worldBossKill });

  if (totalDeath > tableDeath) then
    table.insert(creepList, { name = "总计死亡", value = totalDeath });
  else
    table.insert(creepList, { name = "总计死亡", value = tableDeath });
  end
  table.insert(creepList, { name = "    一般死亡", value = normalDeath });
  table.insert(creepList, { name = "    被稀有杀死", value = rareDeath });
  table.insert(creepList, { name = "    被精英杀死", value = eliteDeath });
  table.insert(creepList, { name = "    被稀有精英杀死", value = rareEliteDeath });
  table.insert(creepList, { name = "    被boss杀死", value = worldBossDeath });
