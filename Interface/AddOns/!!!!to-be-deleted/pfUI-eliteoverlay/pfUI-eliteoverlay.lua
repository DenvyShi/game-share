pfUI:RegisterModule("EliteOverlay", function ()
  ...
  function pfUI.uf:RefreshUnit(unit, component)
    ...
    if elite == "worldboss" then
      unit.dragonTop:Show()
      unit.dragonTop:SetVertexColor(1,.5,1,1)
      unit.dragonBottom:Show()
      unit.dragonBottom:SetVertexColor(1,.5,1,1)
    elseif elite == "rareelite" then
      unit.dragonTop:Show()
      unit.dragonTop:SetVertexColor(1,.5,0,1)
      unit.dragonBottom:Show()
      unit.dragonBottom:SetVertexColor(1,.5,0,1)
