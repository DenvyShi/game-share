...
function OneBagButton:OnInitialize()
	...
	local OneBagView = CreateFrame("Button", "OneBagView", OneBagFrame)
	SetSize(OneBagView, 25, 25)
	OneBagView:SetPoint("RIGHT", OneBagClean_Up, "LEFT", -3, 0)
	...
	OneBagView:SetHighlightTexture("Interface\\Buttons\\UI-Common-MouseHilight", "ADD")
	OneBagView:GetHighlightTexture():SetTexCoord(.09,.91,.09,.91)
	...
	if IsAddOnLoaded("LootFilter") then
		...
		OneBagLootFilter:SetPoint("RIGHT", OneBagView, "LEFT", -3, 0)
