...
AtlasQuest.data = {
	...
	[28] = {
		[1] = {
			...
			[2] = {
				["note"] = "你可以在"..NORMAL.."[52 / 45]"..WHITE.."处找到玛尔冯·瑞文斯克。",
				["id"] = 3446,
				["attain"] = 46,
				["aim"] = "到塔纳利斯找到玛尔冯·瑞文斯克。",
				["followup"] = "有，石环",
				["prequest"] = "The Stone Circle",
				["location"] = "安吉拉斯·月风（菲拉斯 - 羽月要塞; "..NORMAL.."[31 / 45]"..WHITE.."）",
				["level"] = 51,
				["title"] = "沉没的神庙",
			},
			[3] = {
			...
			[16] = {
				...
				["followup"] = "泰兰德和雷姆洛斯",
				["prequest"] = "有，简单的要求 -> 密文碎片",
				["location"] = " 大法师克希雷姆（艾萨拉; "..NORMAL.."[29 / 40]"..WHITE.."）",
				["level"] = 52,
				["title"] = "碧蓝钥匙（盗贼任务）",
			},
			[17] = {
		...
		[2] = {
			...
			[2] = {
				["note"] = "玛尔冯·瑞文斯克的位置在"..NORMAL.."[52 / 45]"..WHITE.."。",
				["id"] = 3446,
				["attain"] = 46,
				["aim"] = "到塔纳利斯找到玛尔冯·瑞文斯克。",
				["followup"] = "有，石环",
				["prequest"] = "The Stone Circle",
				["location"] = "巫医尤克里（菲拉斯; "..NORMAL.."[74 / 43]"..WHITE.."）",
				["level"] = 51,
				["title"] = "沉没的神庙",
			},
			[3] = {
			...
			[17] = {
				["note"] = "圣骑士职业任务。腐烂藤蔓掉落自召唤的阿塔拉利恩"..NORMAL.."[1]"..WHITE.."，必须正确的破解雕像群的秘密。麦拉·黎明之刃在（提瑞斯法林地 - 亡灵壁垒; "..NORMAL.."[83 / 71]"..WHITE.."）。",
				["id"] = 40400,
				["attain"] = 50,
				["aim"] = "揭开阿塔哈卡神庙的秘密，释放阿塔拉利恩并击败他，从他的尸体上取走腐烂藤蔓。完成任务之后向亡灵壁垒的麦拉·黎明之刃复命。",
				["rewards"] = {
					[1] = {
						["subtext"] = L.ONEHAND..", "..L.SWORD,
						["name"] = "Darkwind Glaive",
				...
				["title"] = "远古的邪恶（圣骑士）",
				["prequest"] = "有，前往亡灵壁垒  ->  女妖之王的智慧",
				["location"] = "希尔瓦娜斯·风行者（幽暗城 - 皇家区; "..NORMAL.."[59 / 94]"..WHITE.."）",
				["level"] = 52,
				["followup"] = "不择手段 V",
			},
			[18] = {
	...
	[49] = {
		...
		[2] = {
			...
			[10] = {
				...
				["note"] = "伊加尔弗 "..NORMAL.."[12]|r 掉落破碎的血石吊坠，该物品会开启此任务。若要获得 “黑暗女王的神器”，你需要完成来自大法师沃迪恩・伍德格赖尔的 “越狱” 任务。 (希尔斯布莱德丘陵 - 塔伦米尔 "..NORMAL.."[61.6 / 20.8]|r).",
				["location"] = "破碎的血石吊坠。",
				["attain"] = 32,
				["level"] = 38,
