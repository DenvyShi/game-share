...
local function GetSpellCost(spellSlot)
    ...
    local _, _, cost = string.find(CM_ScanTip.costFontString:GetText() or "", "^(%d+)")
...
CM_ScanTip.costFontString = CM_ScanTip:CreateFontString()
CM_ScanTip.rangeFontString = CM_ScanTip:CreateFontString()
CM_ScanTip:AddFontStrings(CM_ScanTip:CreateFontString(), CM_ScanTip:CreateFontString())
CM_ScanTip:AddFontStrings(CM_ScanTip.costFontString, CM_ScanTip.rangeFontString)
