...
BCS["L_MANAREGEN"] = {
	...
	["cast_mana_percent_regen_3"] = "装备： 使你在施法时仍保持(%d+)%%的法力值回复速度。",
...
BCS["L_SPELLPOWER"] = {
	...
	["Dream_Mongoose"] = "^法术伤害和治疗效果提高(%d+)点，\r\n敏捷提高25点，\r\n物理和法术致命一击几率提高(%d+)%%",
	["Unity_of_the_Timbermaw"] = "^法术伤害和治疗效果提高(%d+)点，攻击强度提高12点。",
	
	["Wizard_Oil"] = "^巫师之油(%D+)",
	["Brilliant_Wizard_Oil"] = "^卓越巫师之油(%D+)",
	["Minor_Wizard_Oil"] = "^初级巫师之油(%D+)",
}
...
BCS["L_HIT"] = {
	...
	["Signet_of_Howling_Nightmares"] ="^装备： 命中几率降低(%d)%%。", 
}
