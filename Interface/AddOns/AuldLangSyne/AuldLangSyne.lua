        ...
        for i=1, n, 1 do
            ...
            if self.db.realm.chars[name] and self.db.realm.chars[name].level then
                ...
                if self.db.profile.show.compact then
                    ...
                    -- 根据职业设置颜色
                    local classColor = self.db.profile.show.color.class and ("|cff"..BC:GetHexColor(class)) or ""
                    local nlt = (self.db.profile.show.pvp and rank or "")..classColor..name..((self.db.profile.show.color.name and self.db.realm.chars[name].sex) and "|r" or "")..(connected and "" or ("|cff999999 - "..lastseen..L[" ago"]))
                    local it = race..classColor..class..(self.db.profile.show.color.class and "|r" or "")..(connected and "" or "|cff999999")..((self.db.profile.show.guild and self.db.realm.chars[name].guild) and (" <"..self.db.realm.chars[name].guild..">") or "")
