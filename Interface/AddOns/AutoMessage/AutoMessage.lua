...
if (channame == "公会") then
SendChatMessage(am, "GUILD",nil);
elseif (channame == "说") then
SendChatMessage(am, "SAY",nil);
elseif (channame == "大喊") then
SendChatMessage(am, "yell",nil);
elseif (channame == "队伍") then
SendChatMessage(am, "PARTY",nil);
elseif (channame == "团队") then
SendChatMessage(am, "RAID",nil);
elseif (channame == "官员") then
SendChatMessage(am, "OFFICER",nil);
elseif (channame == "表情") then
SendChatMessage(am, "EMOTE",nil);
elseif (channame == "团队警报") then
SendChatMessage(am, "RAID_WARNING",nil);
elseif (channame == "战场") then
SendChatMessage(am, "BATTLEGROUND",nil);
elseif (channame == "私聊") then
SendChatMessage(am, "WHISPER",nil,charname,nil);
...
sendhelpmsg("'/autom' - Opens the Automessenger configuration window");
