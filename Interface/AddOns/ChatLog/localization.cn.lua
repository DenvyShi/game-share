...
if ( GetLocale() == "zhCN" ) then
	...
	CHAT_LOG_SCROLL_LINE_UP = "滚动一行"
	CHAT_LOG_SCROLL_LINE_DOWN = "向下滚动一行"
	CHAT_LOG_SCROLL_SCREEN_UP = "滚动一页"
	CHAT_LOG_SCROLL_SCREEN_DOWN = "向下滚动一页"
	CHAT_LOG_SCROLL_TOP = "滚动到顶部"
	CHAT_LOG_SCROLL_BOTTOM = "滚动到底部"
	...
	--GENERAL INFORMATION
	CHAT_LOG_LOADED_MESSAGE = CHAT_LOG_TITLE .. " " .. CHAT_LOG_VERSION .. " 已载入. 输入 /chatlog " .. CHAT_LOG_PHELP .. " 获得帮助信息."
