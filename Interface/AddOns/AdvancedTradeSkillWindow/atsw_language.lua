...
if (GetLocale()=="zhCN") then
	ATSW_SORTBYHEADERS = "按类别排列";
	ATSW_SORTBYNAMES = "按名字排列";
	ATSW_SORTBYDIFFICULTY = "按困难度排列";
	ATSW_CUSTOMSORTING = "自定义排列";
	ATSW_QUEUE = "队列";
	ATSW_QUEUEALL = "所有队列";
	ATSW_DELETELETTER = "删";
	ATSW_STARTQUEUE = "制作队列中";
	ATSW_STOPQUEUE = "停止制作";
	ATSW_DELETEQUEUE = "清空队列";
	ATSW_ITEMSMISSING1 = "您需要以下物品来生产 ";
	ATSW_ITEMSMISSING2 = ":";
	ATSW_FILTERLABEL = "过滤:";
	ATSW_REAGENTLIST1 = "制作 1x ";
	ATSW_REAGENTLIST2 = " 需要以下材料:";
	ATSW_REAGENTFRAMETITLE = "处理队列需要以下材料:";
	ATSW_REAGENTBUTTON = "材料";
	ATSW_REAGENTFRAME_CH1 = "库存.";
	ATSW_REAGENTFRAME_CH2 = "银行";
	ATSW_REAGENTFRAME_CH3 = "Alt";
	ATSW_REAGENTFRAME_CH4 = "商人";
	ATSW_ALTLIST1 = "以下自己小号 ";
	ATSW_ALTLIST2 = "':";
	ATSW_ALTLIST3 = " 在库存中 ";
	ATSW_ALTLIST4 = " 在银行里  ";
	ATSW_OPTIONS_TITLE = "ATSW 设置";
	ATSWOFIB_TEXT = "在计算可生产物品的数量时\n考虑你银行里的物品";
	ATSWOFIA_TEXT = "在计算可生产物品的数量时\n要考虑库存和备用角色银行中的物品";
	ATSWOFIM_TEXT = "考虑做的项目数的计算\n对生产项目";
	ATSWOFUCB_TEXT = "只显示一个生产物品总数\n下列选项";
	ATSWOFSCB_TEXT = "显示的项目数. 内容\n和数量考虑下列选项创建";
	ATSWOFTB_TEXT = "开启配方提示";
	ATSW_OPTIONSBUTTON = "设置";
	ATSW_BUYREAGENTBUTTON = "从当前选定的商人购买材料";
	ATSWOFAB_TEXT = "自动购买任何可能和必要的东西\n对于当前队列当与供应商交谈时";
	ATSW_AUTOBUYMESSAGE = "ATSW 已自动购买以下项目:";
	ATSW_TOOLTIP_PRODUCABLE = " 当前可以制造"
	ATSW_TOOLTIP_NECESSARY = "制造他, 需要以下材料:";
	ATSW_TOOLTIP_BUYABLE = " (可买)";
	ATSW_TOOLTIP_LEGEND = "(项目清单 / 物品在银行 / 物品的名字)";
	ATSW_CONTINUEQUEUE = "继续队列";
	ATSW_ABORTQUEUE = "中止";
	ATSWCF_TITLE = "继续队列处理?";
	ATSWCF_TEXT = "点击“继续”, 队列处理可以继续.(由于1.10补丁,必须点一次按钮才能制造)";
	ATSWCF_TITLE2 = "队列中的下一个项目是:";
	ATSW_CSBUTTON = "编辑";
	ATSW_AUTOBUYBUTTON_TOPTEXT = "这个商人卖你需要的材料！";
	ATSW_AUTOBUYBUTTON_TEXT = "购买材料";
	ATSW_AUTOBUYCLOSEBUTTON_TEXT = "不";
	ATSW_SHOPPINGLISTFRAMETITLE = "你需要制造在所有保存的atsw队列项目试剂的购物清单:";
	ATSWOFSLB_TEXT = "在拍卖行展示购物清单";
	ATSW_ENCHANT = "附魔";
	ATSW_ACTIVATIONMESSAGE = "ATSW 已经";
	ATSW_ACTIVATED = "开启目前的交易技能";
	ATSW_DEACTIVATED = "目前的交易技能禁用";
	...
	ATSWCS_TITLE = "副技能窗口 - 配方分类编辑";
	ATSWCS_TRADESKILLISTTITLE = "未分类配方";
	ATSWCS_CATEGORYLISTTITLE = "配方分类";
	ATSWCS_ADDCATEGORY = "新的类别";
	ATSWCS_NOTHINGINCATEGORY = "< 清空 >";
