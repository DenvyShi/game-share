...
if klass == "WARRIOR" then
	...
	WHUD_CORE:SetScript(
		...
		function()
			...
			elseif
				event == "CHAT_MSG_COMBAT_SELF_MISSES" or event == "CHAT_MSG_SPELL_DAMAGESHIELDS_ON_SELF" or
			...
			elseif event == "PLAYER_AURAS_CHANGED" then
				...
				WHUD_Glow_OnEvent(event)
			elseif
				event == "COMBAT_TEXT_UPDATE" or event == "PLAYER_TARGET_CHANGED" or event == "SPELL_UPDATE_COOLDOWN" or
