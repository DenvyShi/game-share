...
function CreateFrames()
	...
	for i=1,6 do
		...
		_G["WHUD_CDBAR"..i.."_TIMER"]:SetFont(STANDARD_TEXT_FONT, 20,"THINOUTLINE")
...
function WHUD_Cooldowns_OnEvent(arg1)
	if (GetUnitName("target")) then
		if string.find(arg1,"你的压制") then
			SetCooldown("压制")
		elseif string.find(arg1,"你的复仇") then
			SetCooldown("复仇")
		elseif string.find(arg1,"你的盾击") then
			SetCooldown("盾击")
		elseif string.find(arg1,"你的拳击") then
			SetCooldown("拳击")
		end
	end
end
