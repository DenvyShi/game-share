...
-- Used in tooltips to indicate food quality.
FOM_QUALITY_UNKNOWN	= "%s 未知";
FOM_QUALITY_UNDER	= "%s 不喜欢";
FOM_QUALITY_MIGHT	= "%s 可能吃";
FOM_QUALITY_WILL	= "%s 可以吃";
FOM_QUALITY_LIKE	= "%s 喜欢这个";
FOM_QUALITY_LOVE	= "%s 的最爱";

-- User-visible errors
FOM_ERROR_NO_PET		= "你没有宠物";
FOM_ERROR_PET_DEAD		= "你的宠物已死亡";
FOM_ERROR_NO_FEEDABLE_PET	= "你没有可喂食的宠物";
FOM_ERROR_IN_COMBAT	= "战斗中不能喂食宠物";
FOM_ERROR_FOOD_NOT_FOUND	= "%s 找不到 %s 在背包中。";
FOM_ERROR_NO_FOOD		= "%s 背包中没有食物";
FOM_ERROR_NO_FOOD_NO_FALLBACK	= "%s 背包中没有禁用的食物";

FOM_PRONOUN_MALE 	= "他";
FOM_PRONOUN_FEMALE	= "她";

-- Feeding status messages
FOM_FEEDING_EAT_ANOTHER		= "%s 不喜欢这种食物，请更换食物...";
FOM_FEEDING_FEED_ANOTHER	= "需要喂 %s 其他东西...";
FOM_FEEDING_EAT			= "%s 正在吃 %s。"; 
FOM_FEEDING_FEED		= "投喂了 %s 一个 %s. ";

FOM_PET_HUNGRY		= "%s 饿了!";
FOM_PET_VERY_HUNGRY	= "%s 要饿死了!";
...
FOM_OPTIONS_HEADER = "Feed-Matic 设置选项";
FOM_OPTIONS_GENERAL = "基本设置:";
FOM_OPTIONS_FOOD_CHOICE = "排除烹饪用食物:";
FOM_OPTIONS_FEED_NOTIFY = "喂食时通知：";
FOM_OPTIONS_WARNING = "喂食提醒:";

FOM_KEEPOPEN = "至少保留";
FOM_KEEPOPEN_SLOTS = "背包中有空位";
FOM_KEEPOPEN_INFO = "(在空间不足的情况下，无论你的宠物多么喜欢，都会从较小的食物堆中选择食物。)";

FOM_OptionsButtonText = {
	["Tooltip"]	= "显示宠物信息",
	["AvoidQuestFood"]	= "排除任务用食物",
	["AvoidBonusFood"]	= "排除提供增益的食物",
	["PreferHigherQuality"]	= "宠物偏好优先",
	["Fallback"]	= "没有食物时可以吃已经排除的食物",
	["SaveForCook_All"]	= "全部烹饪用食物",
	["SaveForCook_Green"]	= "仅食用|cff3fbf3f\"低级\"|r 或喜欢",
	["SaveForCook_Yellow"]	= "仅食用|cffffff00\"中等\"|r 或喜欢",
	["SaveForCook_Orange"]	= "仅食用|cffff7f3f\"高级\"|r 偏爱",
	["SaveForCook_None"]	= "不保留烹饪可以使用食物",
	["IconWarning"]	= "图标闪缩",
	["TextWarning"]	= "消息提醒",
	["AudioWarning"]	= "声音提醒",
	["AudioWarningBell"]	= "通用提示音",
	["AlertEmote"]	= "使用表情 (其他人可见)",
	["AlertChat"]	= "聊天窗口 (仅自己可见)",
	["AlertNone"]	= "关闭通知",
	["LevelContent"]	= "当满足时",
	["LevelUnhappy"]	= "当愤怒时",
	["LevelOff"]	= "关闭提醒",
