...
NECROSIS_PLAYER_OFFLINE = "offline";
NECROSIS_PARSECRITICALDAMAGE = "Your (.+) crits (.+) for (%d+).";
NECROSIS_PARSESPELLCASTFAILED = "Your (.+) fails. (.+) is immune.";
NECROSIS_CHANNELNAME = {"Say","Yell","Party","Group","Guild"};
NECROSIS_TARGET_DEAD = "(.+) dies";
NECROSIS_MOUNTITEMNAME_KEYWORD = "";
NECROSIS_MOUNTITEMDESCRIPTION_KEYWORD = "Mount";
NECROSIS_SUMMONALERT = "The target is too near!!!";
end
