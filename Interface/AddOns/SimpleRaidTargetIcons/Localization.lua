...
if LOCALE == "zhCN" then
  ...
  L["Vekniss Warrior"] = "维克尼战士" -- needs translation
  L["Vekniss Soldier"] = "维克尼斯士兵" -- needs translation
      -- creature types
      L["Humanoid"] = "人形生物"
      L["Giant"] = "巨人"
      L["Beast"] = "野兽"
      ...
      L["Mechanical"] = "机械"
      -- Options
      L["/srti\n no command opens the options menu\n commands to set icon on target"] = " /srti\n 没有命令打开选项菜单\n 在目标上设置图标的命令"
      L["Demoted"] = "移除标记权限"
      L["Not Promoted"] = "不能提升权限"
      L["Party leader is out of range of target."] = "队长超出目标范围."
      L["Promoted"] = "添加标记权限"
      L["Click above to test settings"] = "点击上面测试设置"
      L["Demote SRTI Assistant"] = "移除可标记成员"
      L["Demotes party member from SRTI assistant."] = "从标记成员组中移除该成员."
      ...
      L["Promote SRTI Assistant"] = "添加可标记成员"
      L["Promotes party member to SRTI assistant."] = "使队友具有标记权限"
      L["Quick"] = "快"
      L["Radial Menu Options"] = "径向菜单选项"
      L["Select Icon on Hover"] = "在悬停上选择图标"
      L["Slow"] = "慢"
      L["SRTI Assistant"] = "标记助手"
      L["SRTI Assistants"] = "添加可标记成员"
      L["SRTI Disabled"] = "禁用标记助手"
      L["SRTI Not Promoted"] = "不能添加"
      L["Test Me"] = "测试"
  ...
  -- CC Immune
    -- ZG
  L["Gurubashi Champion"] = "Gurubashi Champion"
  L["Gurubashi Berserker"] = "Gurubashi Berserker"
    -- MC
  L["Ancient Core Hound"] = "Ancient Core Hound"
  L["Firelord"] = "Firelord"
  L["Flameguard"] = "Flameguard"
  L["Firewalker"] = "Firewalker"
    -- BWL
  L["Death Talon Captain"] = "Death Talon Captain"
  L["Death Talon Wyrmguard"] = "Death Talon Wyrmguard"
  L["Death Talon Flamescale"] = "Death Talon Flamescale"
  L["Death Talon Seether"] = "Death Talon Seether"
  L["Death Talon Overseer"] = "Death Talon Overseer"
  L["Blackwing Spellbinder"] = "Blackwing Spellbinder"
  L["Blackwing Technician"] = "Blackwing Technician"
  L["Blackwing Warlock"] = "Blackwing Warlock"
  -- Kill Targets
  L["Firewalker"] = "Firewalker"
  L["Flameguard"] = "Flameguard"
  L["Lava Elemental"] = "Lava Elemental"
  L["Lava Reaver"] = "Lava Reaver"
  L["Gurubashi Berserker"] = "Gurubashi Berserker"
  -- Packs
  L["Slavering Ghoul"] = "Slavering Ghoul"
  L["Firesworn"] = "Firesworn"
  L["Core Hound"] ="Core Hound"
  L["Flamewaker Healer"] = "Flamewaker Healer"
  L["Flamewaker Elite"] ="Flamewaker Elite"
  L["Buru Egg"] = "Buru Egg" -- needs checking
